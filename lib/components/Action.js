       ...
       return (
         <section
           ...
           <article
              ...
              <button className="ActionComplete"
              onClick={() => {
                this.setState({ isCompleted: true });
                this.props.reference.update( { isCompleted : this.state.isCompleted });}}></button>
              <textarea
                ...
                onBlur={(e) => {
                  ...
                  this.props.reference.set({ title: this.state.title, category: this.state.category, isCompleted: this.state.isCompleted});
                }
              }
              />
